        ...
        private void btnWithdraw_Click(object sender, EventArgs e)
        {
            if(isvalid())
            {
                try
                {
                    ...
                    {
                        string query = "SELECT * FROM Students WHERE Email = '" + txtEmail.Text + "'";
                        ...
                        if (dt.Rows.Count == 1)
                        {
                            ...
                            while (rdr.Read())
                            {
                                password = rdr.GetString(7).ToString();
                                break;
                            }
                        ...
                        {
                            MessageBox.Show("Email does not exist please go consult with the admin");
                            txtEmail.Clear();
                        }
                        con.Close();
                    }
